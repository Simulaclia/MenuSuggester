...
public class FSP_Controller {
	...
	void initialize() {
		// リストに食材を追加
		FoodList.getItems().addAll("食材を選択", "じゃがいも", "豚ひき肉", "キャベツ", "きくらげ", "タケノコ", "オイスターソース", "ねぎ", "きゅうり", "卵",
				"にんじん", "片栗粉", "醤油", "出汁", "味噌", "麺つゆ", "塩", "鰹節", "人参", "卵白", "里芋", "アスパラ", "ピーマン", "小麦粉", "豚バラ",
				"鶏もも", "しょうゆ", "豚肉", "マヨネーズ", "たまご", "たまねぎ", "ベーコン", "鳥もも肉", "ひき肉", "グリンピース", "バター", "鶏肉", "パン粉",
